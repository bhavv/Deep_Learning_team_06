...
Description: Developed a high-performance object detection system using YOLOv5 trained on the BDDK (Berkeley DeepDrive Kitti-Style) dataset. The project focused on improving detection of small and challenging road objects by combining robust augmentation, anchor tuning, and advanced training techniques.
